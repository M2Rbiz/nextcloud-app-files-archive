      ...
      $initialState->provideInitialState('config', [
        ...
        SettingsController::MOUNT_STRIP_COMMON_PATH_PREFIX_DEFAULT => filter_var(
          $cloudConfig->getUserValue(
            ...
            $cloudConfig->getAppValue($appName, SettingsController::MOUNT_STRIP_COMMON_PATH_PREFIX_DEFAULT, false)),
        ...
        SettingsController::EXTRACT_STRIP_COMMON_PATH_PREFIX_DEFAULT => filter_var(
          $cloudConfig->getUserValue(
            ...
            $cloudConfig->getAppValue($appName, SettingsController::EXTRACT_STRIP_COMMON_PATH_PREFIX_DEFAULT, false)),
          FILTER_VALIDATE_BOOLEAN),
