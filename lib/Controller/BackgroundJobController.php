...
class BackgroundJobController extends Controller
{
  ...
  public function __construct(
    ...
    $this->stripCommonPathPrefixDefault[ArchiveJob::TARGET_MOUNT] = (bool)$cloudConfig->getUserValue(
      ...
      $cloudConfig->getAppValue($this->appName, SettingsController::MOUNT_STRIP_COMMON_PATH_PREFIX_DEFAULT, false));
    ...
    $this->stripCommonPathPrefixDefault[ArchiveJob::TARGET_EXTRACT] = (bool)$cloudConfig->getUserValue(
      ...
      $cloudConfig->getAppValue($this->appName, SettingsController::EXTRACT_STRIP_COMMON_PATH_PREFIX_DEFAULT, false));
  }
  // phpcs:enable
